...
console.log('\n测试其他插件:');
const testCases = [
  { extension: 'roo-cline', publisher: 'rooveterinaryinc', version: '3.27.0' },
  { extension: 'cpptools', publisher: 'ms-vscode', version: '1.18.5' },
];
...
testCases.forEach((testCase, index) => {
  ...
  console.log(
    `用例 ${index + 1}: ${testCase.publisher}.${testCase.extension}@${testCase.version}`,
  );
  console.log(`链接: ${url}`);
});
...
console.log('\n使用方法:');
console.log(
  '1. 生成链接: node index.js generate <publisher> <extension> <version>',
);
console.log(
  '2. 下载文件: node index.js download <publisher> <extension> <version>',
);
